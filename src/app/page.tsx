    ...
    <div style={{fontFamily:"'DM Sans',sans-serif",background:'#fff',minHeight:'100vh'}}>
      <section style={{background:`linear-gradient(135deg,${N} 0%,${T} 100%)`,padding:'64px 24px',textAlign:'center',position:'relative',overflow:'hidden'}}>
        <div style={{position:'relative',zIndex:1,maxWidth:600,margin:'0 auto'}}>
          ...
          <h1 style={{fontSize:'clamp(22px,4vw,38px)',color:'#fff',lineHeight:1.2,marginBottom:14,fontWeight:700}}>Programa de Parcerias no<br/><span style={{color:C}}>Cuidado Domiciliar</span></h1>
