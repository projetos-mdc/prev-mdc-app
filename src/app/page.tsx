  ...
  return (
    <div style={{fontFamily:"'DM Sans',sans-serif",background:'#fff',minHeight:'100vh'}}>
      ...
      <footer style={{padding:'32px 24px',marginTop:32,background:N,textAlign:'center'}}>
        <div style={{display:'flex',justifyContent:'center',marginBottom:12}}><img src="/logo-mdc.png" alt="Meu Dentista em Casa" style={{height:40,filter:'brightness(0) invert(1)'}} /></div>
        ...
        <p style={{color:'#475569',fontSize:11,marginTop:16}}>© 20