  ...
  return (
    <div style={{fontFamily:"'DM Sans',sans-serif",background:'#fff',minHeight:'100vh'}}>
      ...
      <footer style={{padding:'32px 24px',marginTop:32,background:N,textAlign:'center'}}>
        <img src="/logo-mdc.png" alt="Meu Dentista em Casa" style={{height:40,filter:'brightness(0) invert(1)',marginBottom:8,display:'block',margin:'0 auto 8px'}} />
        ...
        <p style={{color:'#475569',fontSize:11,marginTop:16}}>© 2026 Meu Dentista em Casa</